  ...
  return (
    <ul className="w-full">
      <div className="flex items-center w-full p-4 gap-x-4 border-t-2">
        <Image src="hearts.svg" alt="heart" width={60} height={60} />
        <div className="flex-1">
          <p className="text-neutral-700 text-base lg:text-xl font-bold">Refill hearts</p>
        </div>
        <Button onClick={onRefilHearts} disabled={hearts === 5 || points < POINTS_TO_REFILL || pending}>
          {hearts === 5 ? "Full" : (
      ...
      <div className="flex items-center w-full p-4 pt-8 gap-x-4 border-t-2">
        ...
        <div className="flex-1">
          <p className="text-neutral-700 text-base lg:text-xl font-bold">Ulimited hearts</p>
        </div>
        <Button
          disabled={pending}
          onClick={onUpgrade}
